...
def plot_average_firing_rate_mec(cell_indices):
    # Parameters
    ...
    traj_time, x_pos, y_pos, head_dir, velocity = rat_trajectory('Sqr')
...
# Example usage:
shape = 'Sqr'
cell_indices = [0, 9, 10, 11, 18, 20, 21, 23, 24, 25, 26, 27, 35, 36, 39, 40, 41, 43, 46]
plot_average_firing_rate_mec(cell_indices)